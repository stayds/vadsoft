                        ...
                        <div class="widget-header">
                            <div class="row">
                                <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                    <h4>Add Key Performance Index</h4>
                                </div>
                            </div>
                        </div>
                        <div class="widget-content widget-content-area">
                            <form action="{{route('post.kpi.create')}}" method="POST">
                                @csrf
                                ...
                                @if(is_array($organ))
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <select class="form-control" name="routine" required >
                                            <option>Select ...</option>
                                            @foreach($routine as $list)
                                                <option class="text-capitalize" value="{{$list}}">{{$list}}</option>
                                            @endforeach
                                        </select>
                                    </div>
{{--                                    <div class="form-group col-md-4">--}}
...
{{--                                    </div>--}}
                                ...
                                @endif
                                <button type="submit" class="btn btn-primary mt-3 btn-lg">Add KPI</button>
                            </form>
                        </div>
                    </div>
                </div>
