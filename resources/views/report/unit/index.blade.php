...
@section('content')
                ...
                <div id="tableSimple" class="col-lg-12 col-12 layout-spacing">
                    <div class="statbox widget box box-shadow">
                        ...
                        <div class="widget-content widget-content-area">
                            <form id="unitbttn" action="{{route('get.unit.report')}}">
                                @csrf
                                ...
                                <div class="form-row mb-3">
                                    <div class="form-group col-md-6">
                                        <label for="DeptName">Unit</label>
                                        <select id="unitid" class="form-control" name="unitid" required>
    ...
    <div id="content" class="main-content unitinfo">
            ...
            $('#repbttn').click(function (event) {
                ...
                $.ajax({
                    ...
                    beforeSend: function() {
                        ...
                        $('#unitid').attr('disable',true)
                    },
                    success: function(data){
                        let contents = $('.unitinfo');
                        contents.html(data);
                    },
                    error: function(data){
