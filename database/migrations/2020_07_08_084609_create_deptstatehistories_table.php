...
class CreateDeptstatehistoriesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('deptstatehistories', function (Blueprint $table) {
            $table->bigIncrements('id');

            $table->bigInteger('deptstateid')->unsigned();
            $table->foreign('deptstateid')
                ->references('id')
                ->on('deptstates');
    ...
    {
        Schema::dropIfExists('depteffecthistories');
    }
}
