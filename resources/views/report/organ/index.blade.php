...
@section('content')
                ...
                <div id="tableSimple" class="col-lg-12 col-12 layout-spacing">
                    <div class="statbox widget box box-shadow">
                        ...
                        <div class="widget-content widget-content-area">
                            <form id="deptbttn" action="{{route('get.organisation.report')}}">
                                @csrf
                                ...
                                <div class="form-row mb-3">
                                    <div class="form-group col-md-6">
                                        ...
                                        <select id="organid" class="form-control" name="organid" required>
    ...
    <div id="content" class="main-content deptinfo">
            ...
            $('#repbttn').click(function (event) {
                ...
                $.ajax({
                    ...
                    beforeSend: function() {
                        ...
                        $('#deptid').attr('disable',true)
                    },
                    success: function(data){
                        let contents = $('.deptinfo');
                        contents.html(data);
                    },
                    error: function(data){
