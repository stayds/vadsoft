    ...
    <nav id="sidebar">
        ...
        <ul class="list-unstyled menu-categories" id="accordionExample">
            ...
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="org" data-parent="#accordionExample">
                    <li>
                        <a href="{{route('get.organisation.create')}}"> Add </a>
                    </li>
                    <li>
                        <a href="{{route('get.organisation.list')}}"> View List  </a>
                    </li>
                </ul>
            </li>
            <li class="menu">
            ...
            <li class="menu">
                <a href="{{route('get.organisation.report')}}" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-layout"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect><line x1="3" y1="9" x2="21" y2="9"></line><line x1="9" y1="21" x2="9" y2="9"></line></svg>
                        <span>Organisation Report</span>
                    </div>
                </a>
            </li>
{{--            <li class="menu">--}}
