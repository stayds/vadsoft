<div class="row layout-top-spacing">
    ...
    <div class="col-4 offset-4">
        <table class="table table-bordered">
            <tbody>
            <tr>
                <td><a id="rej" href="{{route('get.measure.unit.approve',['measureid'=>$data->measureid,'approve'=>1,'deptstateid'=>$data->id,'historyid'=>$history->id])}}" class="btn btn-danger">Reject</a></td>
                <td><a id="app" href="{{route('get.measure.unit.approve',['measureid'=>$data->measureid,'approve'=>2,'deptstateid'=>$data->id,'historyid'=>$history->id])}}" class="btn btn-primary">Approve</a> </td>
            </tr>
            </tbody>
        </table>
    </div>
