                    ...
                    <div class="widget-content widget-content-area">
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                <tbody>
                                <tr>
                                    <td class="description text-uppercase font-weight-bold">Organisation</td>
                                    <td>{{$name}}</td>
                                </tr>
                                <tr>
                                    <td class="description text-uppercase font-weight-bold">No. Staff</td>
                                    <td>{{$deptstaff}}</td>
                                </tr>
                                <tr>
               ...
               <div class="col-12">
                   <div class="statbox widget box box-shadow">
                       <div class="widget-header">
                           <div class="row">
                               <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                   <h4 class=" text-danger text-center">Sorry no record exist for this department</h4>
                               </div>
                           </div>
                       </div>
