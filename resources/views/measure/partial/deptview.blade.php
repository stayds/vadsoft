<div class="row layout-top-spacing">
                ...
                <div class="widget-content widget-content-area">
                    <div class="table-responsive">
                        <table class="table table-bordered">
                            ...
                            <tr>
                                <td class="description text-uppercase font-weight-bold">Expected Days</td>
                                <td>{{$data->total_num_effv}}</td>
                            </tr>

                            <tr>
                                <td class="description text-uppercase font-weight-bold">Expected Labour</td>
                                <td>{{$data->labour_effv}}</td>
                            </tr>
                            <tr>
                ...
                <div class="widget-content widget-content-area">
                    <div class="table-responsive">
                        <table class="table table-bordered">
                            ...
                            <tr>
                                <td class="description text-uppercase font-weight-bold">Expected Days</td>
                                <td>{{$data->total_num_effy}}</td>
                            </tr>
                            <tr>
                                <td class="description text-uppercase font-weight-bold">Expected Labour</td>
                                <td>{{$data->labour_effy}}</td>
                            </tr>
                            <tr>
                                <td class="description text-uppercase font-weight-bold">Achieved Output</td>
                            ...
                            <tr>
                                <td class="description text-uppercase font-weight-bold">Achieved Labour</td>
                                <td>{{$history->labour_effy}}</td>
                            </tr>
                            <tr>
                                <td class="description text-uppercase font-weight-bold">Achieved Hours</td>
    ...
    <div class="col-4 offset-4">
        <table class="table table-bordered">
            <tbody>
            <tr>
                <td><a id="rej" href="{{route('get.measure.department.approve',['measureid'=>$data->measureid,'approve'=>1,'deptstateid'=>$data->id,'historyid'=>$history->id])}}" class="btn btn-danger">Reject</a></td>
                <td><a id="app" href="{{route('get.measure.department.approve',['measureid'=>$data->measureid,'approve'=>2,'deptstateid'=>$data->id,'historyid'=>$history->id])}}" class="btn btn-primary">Approve</a> </td>
            </tr>
            </tbody>
        </table>
    </div>
