                ...
                <div id="tableSimple" class="col-lg-12 col-12 layout-spacing">
                    <div class="statbox widget box box-shadow">
                        ...
                        <div class="widget-content widget-content-area">
                            <form action="{{route('post.measure.unit')}}" method="POST">
                                @csrf
                                ...
                                <div class="form-row mb-3">
                                    <div class="form-group col-md-4">
                                        <label for="title">Expectated Hours Worked</label>
                                    ...
                                    <table class="table table-bordered mb-4">
                                        ...
                                        @forelse($state as $key=> $list)
                                            <tr>
                                                ...
                                                <td><a href="{{route('get.department.measure.delete',['id'=>$list->id])}}" class="btn btn-danger btn-sm"> Delete </a></td>
                                            </tr>
                                        @empty
